...
export default function Layout() {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-bg-primary">
      {/* Sidebar */}
      <aside className="w-72 flex-shrink-0 bg-white border-r border-border-primary flex flex-col">
        {/* Logo */}
        <div className="px-8 py-6 border-b border-border-primary">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-text-tertiary font-medium">AI Voice Agent</p>
            </div>
          </div>
        </div>
        ...
        <div className="px-6 py-4 border-t border-border-primary space-y-3">
          ...
          <button 
            onClick={logout}
            className="logout-btn w-full px-4 py-3 rounded-xl bg-red-50 text-red-600 font-bold hover:bg-red-100 transition-all flex items-center justify-center gap-2 shadow-sm active:scale-95 border border-red-100"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
