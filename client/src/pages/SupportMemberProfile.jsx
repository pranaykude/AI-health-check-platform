  ...
  return (
    <div className="p-8 space-y-8 animate-fade-in max-w-7xl mx-auto relative">
      ...
      <div className="bg-white border border-border-primary rounded-3xl p-6 shadow-sm flex flex-col md:flex-row items-center gap-6 relative overflow-hidden">
        {/* Accent status bar */}
        <div className={`absolute top-0 left-0 right-0 h-1.5 ${member.status === 'online' ? 'bg-success-500' :
        ...
        <div className="relative">
          ...
          <span className={`absolute -bottom-1 -right-1 w-6 h-6 rounded-full border-4 border-white shadow-md flex items-center justify-center ${member.status === 'online' ? 'bg-success-500' :
              member.status === 'busy' ? 'bg-warning-500' :
                'bg-slate-400'
            }`}>
        ...
        <div className="flex-1 min-w-0 text-center md:text-left space-y-2">
          <div className="flex flex-col md:flex-row md:items-center gap-2.5">
            ...
            <span className={`px-3 py-1 rounded-full text-xs font-bold border self-center md:self-auto capitalize ${member.status === 'online' ? 'bg-success-50 border-success-100 text-success-700' :
        ...
        <div className="lg:col-span-4 bg-white border border-border-primary rounded-3xl p-5 shadow-sm space-y-4">
          ...
          <div className="flex bg-bg-secondary p-1 rounded-2xl border border-border-primary">
            <button
              ...
              className={`flex-1 py-2.5 text-xs font-black uppercase tracking-wider rounded-xl transition-all duration-200 cursor-pointer ${activeLeftTab === 'clients'
            ...
            <button
              ...
              className={`flex-1 py-2.5 text-xs font-black uppercase tracking-wider rounded-xl transition-all duration-200 cursor-pointer ${activeLeftTab === 'activity'
                  ? 'bg-white text-primary-700 shadow-sm border border-border-primary'
                  : 'text-text-tertiary hover:text-text-secondary'
                }`}
            >
                  ...
                  {assignedClients.map((client) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <svg className={`w-4 h-4 text-text-tertiary transition-transform duration-200 ${isSelected ? 'text-primary-600 translate-x-1' : 'group-hover:translate-x-1'
              ...
              <div className="space-y-3 max-h-[60vh] overflow-y-auto pr-1">
                {persistentNotifications.length === 0 ? (
                  ...
                  persistentNotifications.map((notif) => (
                    <div
                      key={notif._id}
                      className={`p-3.5 rounded-2xl border transition-all text-xs font-semibold relative overflow-hidden ${notif.read
              ...
              <div>
                ...
                {aiAlerts.length > 0 && (
                  <div className="space-y-2 mb-6 animate-pulse">
                    {aiAlerts.map((alert, idx) => (
                      <div
                        key={idx}
                        className={`px-4 py-3 rounded-2xl border text-xs font-bold flex items-center justify-between shadow-sm ${alert.type === 'danger'
                ...
                <div className="bg-primary-50/20 border border-primary-100 rounded-3xl p-5 mt-6 space-y-4">
                  <div className="flex items-center justify-between border-b border-primary-100/50 pb-2.5">
                    ...
                    <span className={`px-2.5 py-0.5 rounded-lg text-[10px] font-black uppercase border ${aiDiag.churnRisk === 'High' ? 'bg-danger-50 border-danger-100 text-danger-700 animate-pulse' :
                ...
                <div className="flex flex-wrap border-b border-border-primary mt-6">
                  <button
                    ...
                    className={`px-4 py-2 text-xs font-bold uppercase tracking-wider border-b-2 transition-all cursor-pointer ${activeTab === 'summary'
                  ...
                  <button
                    ...
                    className={`px-4 py-2 text-xs font-bold uppercase tracking-wider border-b-2 transition-all cursor-pointer ${activeTab === 'escalations'
                  ...
                  <button
                    ...
                    className={`px-4 py-2 text-xs font-bold uppercase tracking-wider border-b-2 transition-all cursor-pointer ${activeTab === 'chat'
                        ? 'border-primary-500 text-primary-600'
                        : 'border-transparent text-text-tertiary hover:text-text-secondary'
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`px-4 py-2 text-xs font-bold uppercase tracking-wider border-b-2 transition-all cursor-pointer ${activeTab === 'notes'
                        ? 'border-primary-500 text-primary-600'
                        : 'border-transparent text-text-tertiary hover:text-text-secondary'
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`px-4 py-2 text-xs font-bold uppercase tracking-wider border-b-2 transition-all cursor-pointer ${activeTab === 'emails'
                        ? 'border-primary-500 text-primary-600'
                        : 'border-transparent text-text-tertiary hover:text-text-secondary'
                      }`}
                  >
                            ...
                            >
                              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-border-primary pb-2.5">
                                <div className="flex items-center gap-2">
                                  <span className={`w-2.5 h-2.5 rounded-full ${call.status === 'recorded' ? 'bg-success-500' :
                                ...
                                <span className={`text-[10px] font-bold px-2 py-0.5 rounded-md uppercase border ${call.sentiment?.toLowerCase() === 'positive' ? 'bg-success-50 border-success-100 text-success-700' :
                        ...
                        {clientRooms.map((room) => {
                          ...
                          return (
                            <button
                              ...
                              className={`w-full text-left p-2.5 rounded-xl text-xs font-bold transition-all transition-colors truncate block cursor-pointer ${isActive
                                    ...
                                    return (
                                      ...
                                      >
                                        <div className="flex flex-col space-y-1">
                                          ...
                                          <div className={`p-3 rounded-2xl text-xs leading-relaxed border ${isSelf
                      ...
                      <div className="space-y-3">
                        {internalNotes.length === 0 ? (
                          ...
                          internalNotes.map((note) => (
                            <div
                              key={note._id}
                              className={`border rounded-2xl p-4 transition-all bg-white relative overflow-hidden ${note.type === 'escalation' ? 'border-danger-100 bg-danger-50/10' :
                            ...
                            >
                              <div className="flex justify-between items-center gap-2 border-b border-border-primary/50 pb-2 mb-2">
                                ...
                                <span className={`text-[8px] font-black px-2 py-0.5 rounded-md uppercase border ${note.type === 'escalation' ? 'bg-danger-50 border-danger-100 text-danger-700' :
                            ...
                            {clientEmails.map((email) => (
                              ...
                              >
                                <div className="flex justify-between items-center text-xs">
                                  ...
                                  <span className={`px-2 py-0.5 rounded-md text-[8px] font-black uppercase border ${email.deliveryStatus === 'delivered' ? 'bg-success-50 border-success-100 text-success-700' :
                    ...
                    .map((client) => {
                      ...
                      return (
                        <div
                          ...
                          className={`flex items-center gap-4 px-4 py-3 rounded-2xl border transition-all cursor-pointer hover:border-primary-300 ${isChecked
                              ? 'bg-primary-50/50 border-primary-300 shadow-sm'
                              : 'bg-white border-border-primary'
                            }`}
                        >
                          <div className={`w-5 h-5 rounded-lg border-2 flex items-center justify-center transition-all ${isChecked ? 'bg-primary-600 border-primary-600 text-white' : 'border-border-secondary bg-white'
                            }`}>
                            {isChecked && (
